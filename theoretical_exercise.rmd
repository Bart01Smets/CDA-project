...
The expected value of the <moet hier nog 'mean' staan?> income of a female is `r -beta[4]` pounds less than that of a male, assumed that they are in the same age group (11 years, 13 years or 15 years).
...
- $\beta_4 =$ `r beta[5]`: `r beta[4]` ($\beta_3$) + `r beta[5]` ($\beta_4$) $=$ `r beta[4]+beta[5]`, so a female of 13 years old is expected to have an income of `r -beta[4]-beta[5]` pounds less than a male of 13 years old;
...
print(beta_hat[2]) #13
print(beta_hat[3]) #15
print(beta_hat[4]) #female
print(beta_hat[5]) #13,female
print(beta_hat[6]) #15, female

SSE_groups <- sum((n-1)*(sds^2))
SSE_total <- SSE_groups
MSE <- SSE_total/(ntot-6)
print(MSE)

```

For 11yo; females earn 0.18 less than males (-0.18)
for13yo; 0.48 less than males (-0.18-0.3)
For 15yo; females earn 0.81 less than males (-0.18-0.63)
