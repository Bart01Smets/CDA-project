...
The expected value of the income of a female is 0.49 pounds less that of a male, assumed that they are in the same age group (11 years, 13 years or 15 years).
...
$$Y_i = \beta_0 + \beta_1 \cdot \text{Age13}_i + \beta_2 \cdot \text{Age15}_i + \beta_3 \cdot \text{Female}_i + \beta_4 \cdot \text{Age13}_i \cdot \text{Female}_i + \beta_5 \cdot \text{Age15}_i \cdot \text{Female}_i+ \varepsilon_i$$
