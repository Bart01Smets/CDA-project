...
$$\hat{\sigma}^2 = \frac{\sum_{j=1}^{6} (n_j - 1) s_j^2}{N - p}$$
...
Females have a lower income on average than males, across all age groups together. The difference is small though (0.49 pounds).
