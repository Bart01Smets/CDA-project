...
The assumption of independence would be violated as observations are correlated (brothers and sisters come from the same family <where for example the same amount for pocket money will be given>).
