...
sjlabelled::set_label(plot_df) <- c("estimated probability", "raw residuals")

# plot
ggplot(plot_df, aes_string("prob","raw_res"))+
  geom_point(alpha = 0.1) +
  geom_smooth(se = FALSE, method = "loess") +
  scale_x_continuous(breaks = seq(0,1,0.1)) +
  scale_y_continuous(limits = c(-3,3))
```
When the residuals are plotted the smoother lies close to zero, indicating that the logistic regression model fits the data well.
