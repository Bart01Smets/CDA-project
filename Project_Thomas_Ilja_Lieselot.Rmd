...
```{r}
x <- sum(train_data$y)          # number of successes observed
n <- length(train_data$y)       # number of trials
binom.confint(x, n, method = "exact", conf.level=0.95)        # Clopper–Pearson
binom.confint(x, n, method = "asymptotic", conf.level=0.95)   # Wald (approx)
```
