...
## Binary
```{r}
y_mean <- mean(train_data$ViolentCrimesPerPop)
...
y_mean_test <- mean(test_data$ViolentCrimesPerPop)
...
roc
calc_auc(roc)
roc_test <- roc(test_data$y, pred_prob_test) # deze geeft ook auc, kwestie van voorkeur
```
