...
For the second part of this project, the response variable *ViolentCrimesPerPop* was dichotomized to fit a generalized linear model. Therefor the whole dataset was split at the median value to create 2 categories, the lower half of the response variables coded as 0 (low violent crime rate) and the top half of the response variable coded as 1 (high violent crime rate). 
