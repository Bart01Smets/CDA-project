...
par(mfrow = c(1, 1))
```
Applying the log transformation offered a substantial improvement of our model showing approximate constant variances and residuals reasonably close to normal.
