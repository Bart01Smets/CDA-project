...
I was also investigated wheter or not small communities have a higher probability to have more extreme values of the response and predictor variables, scatter plots were created with log(*population*) as x variable (see appendix). The resulting scatterplots show that communities with a very small population indeed show a very large spread for all variables.
...
#### Notes on interpretation ---> NIET BACKTRANSFORMEN
