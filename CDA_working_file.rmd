...
high_dfbetas <- apply(abs(dfbetas_val), 1, function(x) any(x > dfbetas_threshold))

diagnostics$high_dfbetas <- high_dfbetas

# Select only the flag columns
...
problematic_with_data[, c("flag_count", "communityname", "population.y", "PctPopUnderPov", "PctBSorMore", "racepctblack", "agePct12t29", "PctImmig", "ViolentCrimesPerPop")]
