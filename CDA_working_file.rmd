...
formula_final <- as.formula(paste("logViolent ~", 
                                  ...
                                  "PctPopUnderPov:race_black_logit + PctPopUnderPov:PctLess9thGrade + PctPopUnderPov:PctImmig + PctPopUnderPov:PctBSorMore"))
...
formula_final <- as.formula(paste("logViolent ~", 
                                  paste(predictor_list, collapse = " + "), "+",
                                  "PctPopUnderPov:race_black_logit + PctPopUnderPov:PctLess9thGrade + PctPopUnderPov:PctBSorMore"))
...
formula_final <- as.formula(paste("logViolent ~", 
                                  ...
                                  "PctPopUnderPov:race_black_logit  + PctPopUnderPov:PctBSorMore"))
...
formula_final <- as.formula(paste("logViolent ~", 
                                  paste(predictor_list[-2], collapse = " + "), "+",
                                  "PctPopUnderPov:race_black_logit"))
