...
partial_residual_plot <- function(data, outcome, predictor, predictor_list) {
  temp <- train_data
...
plots <- lapply(predictor_list, function(predictor_added) {
    partial_residual_plot(train_data, "ViolentCrimesPerPop", predictor_added, predictor_list)
}
)
