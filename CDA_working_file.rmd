...
Figures to get a visual illustration of whether outliers are more common in small pop.
...
cat("Original model adjusted R²: ", round(summary(fit_final1)$adj.r.squared, 4), "\n") ## dit moet nog aangepast worden
